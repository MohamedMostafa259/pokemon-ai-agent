...
def setup():
    ...
    if not os.path.exists("server"):
        logger.info("Setup: Cloning Pokemon Showdown Server...")
        run_cmd(["git", "clone", "https://github.com/smogon/pokemon-showdown.git", "server"])
    ...
    if not os.path.exists("client"):
        logger.info("Setup: Cloning Pokemon Showdown Client...")
        run_cmd(["git", "clone", "https://github.com/smogon/pokemon-showdown-client.git", "client"])
...
def main():
    logger.info("==========================================")
    logger.info("      Pokemon AI Agent Local Startup      ")
    logger.info("==========================================")
    
    setup()
    
    logger.info("Starting Pokemon Showdown Server...")
    ...
    try:
        ...
        gradio_app.launch(server_name="127.0.0.1", server_port=7860, share=True, css=custom_css, theme=elite_theme)
